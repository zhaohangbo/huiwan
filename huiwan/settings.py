"""
Django settings for huiwan project.
...
SECRET_KEY = '%$zy=g$ym_^1_8(xu8%0km)ca^ffwe!w68c-l^cq3g+27-8g7+'
...
WSGI_APPLICATION = 'huiwan.wsgi.application'
